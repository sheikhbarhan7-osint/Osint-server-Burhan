...
# Player-client fallback order used everywhere we hit the YouTube extractor.
# YouTube periodically blocks specific clients ("Sign in to confirm you're not
# a bot", format-not-available, etc.), so we race through several before
# giving up — the more variety here, the higher the success rate.
YT_PLAYER_CLIENTS = [
...
def _generic_info(url: str):
    ...
    Returns (info_dict_or_None, last_error_str_or_None)."""
    base_opts = {
